...
public class RefreshTokenProcessor implements ResponseBodyAdvice<OAuth2AccessToken>{
	...
	public OAuth2AccessToken beforeBodyWrite(OAuth2AccessToken body, MethodParameter returnType,
		...
		removeRefreshTokenOfTheBody(token);
		
		return body;
	}

	private void removeRefreshTokenOfTheBody(DefaultOAuth2AccessToken token) {
	...
	private void addRefreshTokenInCookie(String refreshToken, HttpServletRequest req, HttpServletResponse resp) {
		...
		refreshTokenCookie.setSecure(artivistasApiProperty.getSecurity().isEnableHttps()); //TODO: Mudar para true em produção
